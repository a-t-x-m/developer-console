...
var DeveloperConsole = /** @class */ (function () {
    ...
    DeveloperConsole.prototype.assert = function (condition) {
        var data = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            data[_i - 1] = arguments[_i];
        }
        this.__console__.apply(this, __spreadArray(['assert', condition], data));
    };
    DeveloperConsole.prototype.count = function (label) {
        this.__console__('count', label);
    };
    DeveloperConsole.prototype.countReset = function (label) {
    ...
    DeveloperConsole.prototype.dir = function (data) {
        this.__console__('dir', data);
    };
    DeveloperConsole.prototype.dirxml = function (data) {
    ...
    DeveloperConsole.prototype.group = function (label) {
        this.__console__('group', label);
    };
    DeveloperConsole.prototype.groupCollapsed = function (label) {
        this.__console__('groupCollapsed', label);
    };
    DeveloperConsole.prototype.groupEnd = function () {
    ...
    DeveloperConsole.prototype.table = function (tabularData) {
        this.__console__('table', tabularData);
    };
    DeveloperConsole.prototype.time = function (label) {
        this.__console__('time', label);
    };
    DeveloperConsole.prototype.timeEnd = function (label) {
        this.__console__('timeEnd', label);
    };
    DeveloperConsole.prototype.timeLog = function (label) {
